...
def _calculate_risk(predict_prob, step, model_dir):
    """Map probability to risk using prediction results."""
    pred_file = join(model_dir, f"predictions_with_label_{step}.csv")
    list_pred_real = []
    try:
